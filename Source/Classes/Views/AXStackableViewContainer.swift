...
@objc public class AXStackableViewContainer: UIView {
    ...
    @objc fileprivate(set) var _anchorPoint: AXStackableViewContainerAnchorPoint // renamed as it now conflicts with UIView's anchorPoint API_AVAILABLE(ios(16.0))
    ...
    @discardableResult fileprivate func computeSize(for constrainedSize: CGSize, applySizingLayout: Bool) -> CGSize {
        ...
        let subviews = (self._anchorPoint == .top) ? self.subviews : self.subviews.reversed()
